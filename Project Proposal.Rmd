...
```{r fig1, echo=FALSE, fig.cap="Figure 1. Distribution of VISITS", fig.width=6, fig.height=4, fig.align='center'}
hist(clean_data$VISITS[clean_data$VISITS], breaks = 50,
     main = "Distribution of VISITS", xlab = "Number of Visits",
     col = "skyblue", border = "white")
```
...
```{r fig2, echo=FALSE, fig.cap="Figure 2. Visits by Location Type", fig.width=6, fig.height=4, fig.align='center'}
boxplot(VISITS ~ LOCALE_GROUP, data = clean_data,
        main = "Visits by Location Type",
...
```{r fig3, echo=FALSE, fig.cap="Figure 3. Programs vs. Visits by Locale (<20k Programs)", fig.width=6, fig.height=4, message=FALSE}
